...
class ImmoCost extends CommonObject
{
	...
	public $fields = array(
		...
		'label'         => array(
			...
			'notnull' => -1,
			'searchall' => 1,
			'help' => 'ImmoCostLabelInfo',
			'showoncombobox' => '1',
		),
		'fk_property'   => array(
			'type'    => 'integer:ImmoProperty:ultimateimmo/class/immoproperty.class.php',
			'label'   => 'Property',
			'enabled' => 1,
			'visible' => 1,
			'position' => 35,
		...
		'fk_owner'      => array(
			'type'  => 'integer:ImmoOwner:ultimateimmo/class/immoowner.class.php',
			'label' => 'Owner',
			'enabled' => 1,
			'visible' => 1,
			'position' => 40,
		...
		'fk_soc'        => array(
			...
			'index' => 1,
			'searchall' => 1,
			'help' => "LinkToThirdparty",
		),
		'fk_cost_type'  => array(
			'type'    => 'integer:ImmoCost_Type:ultimateimmo/class/immocost_type.class.php',
			'label'   => 'ImmoCostType',
			'enabled' => 1,
			'visible' => 1,
			'position' => 50,
